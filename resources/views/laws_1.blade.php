...
<div class="d-flex">
    <div>
        <section id="main-section" class="d-flex justify-content-between vw-65">
            <div class="ml-146">
                <div class="p-0">
                    <h1 class="text-black fw-700">1995</h1>
                    <p class="text-black fs-24 fw-700 font-normal lh-normal mt-22" style="width: 25ch;">Bhutan's Forest and Nature Conservation Act - "Conservation and sustainable management of Bhutan's forests."</p>
                </div>
            </div>
        ...
        <div style="">
            <div class="ml-146">
                <ul class="d-flex list-none text-black mt-22">
                    <li class="mr-50"><a href="/the-laws-1" class="spin-button fs-14 lh-normal font-normal fw-400 no-underline text-black ">1999</a></li>
                    <li class="mr-50"><a href="/laws-2000" class="spin-button fs-14 lh-normal font-normal fw-400 no-underline text-black ">2000</a></li>
                    <li class="mr-50"><a href="" class="spin-button fs-14 lh-normal font-normal fw-400 no-underline text-black ">2001</a></li>
                    <li class="mr-50"><a href="" class="spin-button fs-14 lh-normal font-normal fw-400 no-underline text-black ">2002</a></li>
                    <li class="mr-50"><a href="" class="spin-button fs-14 lh-normal font-normal fw-400 no-underline text-black ">2003</a></li>
                    <li class="mr-50"><a href="" class="spin-button fs-14 lh-normal font-normal fw-400 no-underline text-black ">2004</a></li>
                    <li class="mr-50"><a href="" class="spin-button fs-14 lh-normal font-normal fw-400 no-underline text-black ">2005</a></li>
                    <li class="mr-50"><a href="" class="spin-button fs-14 lh-normal font-normal fw-400 no-underline text-black ">2006</a></li>
                    <li class="mr-50"><a href="" class="spin-button fs-14 lh-normal font-normal fw-400 no-underline text-black ">2007</a></li>
                </ul>
            </div>

            <div class="d-flex align-items-center ml-139 pt-5">
