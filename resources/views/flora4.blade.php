...
<section>
    <div class="gallery-container">
        <div class="options">
            ...
            <div class="image-content scroll">Bulbophyllum punakhaense is named after Punakha Dzongkhag where it was first spotted and collected the specimen. The maroon blossoms of the orchid are small and delicate, measuring no more than four centimetres in length. The species is found between elevations of 2000 and 2700 m.</div>
         </div>
        </div>
        ...
        <div class="option">
            ...
            <div class="description">
                <div class="image-content scroll">Chiloschista densiflora, named in reference to the densely flowered inflorescences was discovered from Zhemgang in 2014.The species have yellowish flowers with brown spots on the sepals and petals, but differs by the larger flower, with virtually glabrous to indistinctly micro-pubescent sepals and petals. It is mostly found in Trongsa and Zhemgang.   </div>
            </div>
        </div>
        ...
        <div class="option">
            ...
            <div class="description">
                <div class="image-content scroll">Paphiopedilum fairrieanum, also called Fairrie's Paphiopedilum or Lady's Slipper Orchid, is an orchid species found in Bhutan. It features large, distinctive slipper-shaped flowers in tones of green, yellow, brown, or red. Growing in shaded areas, it contributes to Bhutan's flora and holds cultural significance as a symbol of rare beauty and charm</div>
            </div>
        </div>
