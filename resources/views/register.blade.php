...
<section class="d-flex justify-content-between">
    <div class="mt-197 ml-146">
        <div>
            <h4 class="text-black fw-400 ">Dont miss the latest updates!</h4>
            <form class="d-flex flex-column">
                ...
                <button class="bg-yellow fs-30 font-normal lh-normal mt-50 " type="submit">
                    Register

                    <svg width="34" height="38" viewBox="0 0 34 38" fill="" xmlns="http://www.w3.org/2000/svg">
