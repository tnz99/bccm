<div class="d-flex align-items-center story-control-wrapper">
    <ul class="d-flex align-items-center justify-content-between list-none story-control">
        <li><a href="{{ $linkOne }}" class="no-underline circle-xm d-flex justify-content-center align-items-center mr-10 border-0">1</a></li>
        <li><a href="{{ $linkTwo }}" class="no-underline circle-xm d-flex justify-content-center align-items-center border-0">2</a></li>
        <li class="ml-139">
            <div class="d-flex align-items-center">
                ...
                <div class="circle-xm d-flex justify-content-center align-items-center ml-9">
                    <svg width="36" height="32" viewBox="0 0 38 34" fill="none" xmlns="http://www.w3.org/2000/svg">
