...
<nav id="circular_nav" class="circular-nav  {{ $background }} zoom-in-element">
    ...
    <div class="semi-circle-item"><p class="nav-item nav-item-6"><a class="no-underline text-white font-normal fw-700 fs-20 cnav-link" href="the-flora">The Flora</a></p></div>
    <div class="semi-circle-item"><p class="nav-item nav-item-7"><a class="no-underline text-white font-normal fw-700 fs-20 cnav-link" href="the-kingdom">The Kingdom</a></p></div>
