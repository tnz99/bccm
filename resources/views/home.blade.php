...
<section class="d-flex justify-content-between home-wrapper">
    <div>
        <h2 class="home-header-text">Bhutan Belive:</h2>
        ...
        <button class="register-btn" type="submit">
            ...
            <svg width="32" height="36" viewBox="0 0 34 38" fill="none" xmlns="http://www.w3.org/2000/svg">
...
@section('nav')
<x-circular_nav background="home-cnav-bg" inner-border="border-gray"/>
@endsection
